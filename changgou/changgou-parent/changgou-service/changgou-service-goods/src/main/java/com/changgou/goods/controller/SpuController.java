...
public class SpuController {
    ...
    public Result save(@RequestBody Goods goods) {
        spuService.save(goods);//可以添加 也可以修改
        return new Result(true, StatusCode.OK, "添加成功");
    }

    //根据spu商品的ID 获取商品的组合对象的数据展示
    @GetMapping("/goods/{id}")
    ...
    public Result audit(@PathVariable(name = "id") Long id) {
        ...
        spuService.audit(id);
        return new Result<Goods>(true, StatusCode.OK, "审核通过");
    ...
    public Result putSpu(@PathVariable(name = "id") Long id) {
        ...
        spuService.put(id);
        return new Result<Goods>(true, StatusCode.OK, "上架成功");
     ...
     */
    @PutMapping("/pull/{id}")
    public Result xiajia(@PathVariable(name="id")Long id) {
        spuService.pull(id);
        return new Result<Goods>(true, StatusCode.OK, "下架成功");
    }
